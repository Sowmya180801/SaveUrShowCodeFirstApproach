...
using SaveUrShowCodeFirstApproach.Models;

namespace SaveUrShowCodeFirstApproach.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class RegistrationsController : ControllerBase
    {
        private readonly SaveUrShowCFADbContext _context;

        public RegistrationsController(SaveUrShowCFADbContext context)
        {
            _context = context;
        }
